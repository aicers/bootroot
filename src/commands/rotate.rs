...
const OPENBAO_RECOVERY_SCOPE_UNSEAL_KEYS: &str = "unseal-keys";
const OPENBAO_RECOVERY_SCOPE_ROOT_TOKEN: &str = "root-token";
const OPENBAO_REKEY_INCOMPLETE_ERROR: &str =
