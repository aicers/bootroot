...
- **per-service agents**: `bootroot service add` prints the path and run guidance;
...
`bootroot service add` includes the trusted list in the agent.toml snippet.
In the common workflow, you should use the values printed by service add.
